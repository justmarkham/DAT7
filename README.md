...
* Logistic regression ([notebook](http://nbviewer.ipython.org/github/justmarkham/DAT7/blob/master/notebooks/11_logistic_regression.ipynb))
* Exercise with Titanic data ([instructions](homework/11_titanic.md))
